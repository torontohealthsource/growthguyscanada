# Growth Guys code not applying at checkout — HEALTHYLIFE10 Cart-Tested September 1, 2026

Growth Guys code not applying at checkout, verified today &mdash; cart-tested September 1, 2026 at growthguys.com: HEALTHYLIFE10 took $6.00 CAD off a $60.00 CAD cart, exactly 10% off sitewide, with no minimum purchase and no product exclusions.

## What we actually observed

Variable products do not enter the cart until a variant is chosen, so the code gets blamed for an empty cart. Reproduced deliberately.
...
Yes. It was cart-tested on September 1, 2026 and took $6.00 CAD off a $60.00 CAD cart at growthguys.com — exactly 10%. This page is rebuilt from that test, so the date above is when it was last confirmed, not when it was written.
